...
global.ytname = "YT: Rashirikun!"
global.location = "Guyane, France, Haiti"
global.botscript = "https://github.com/rashirikun/Zero-Two-Md"
...
//═══════[modification]════════\\
global.owner = process.env.BOT_OWNER || ['594694239598'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['594694239598' , '594694239598'] //another owner number
global.premium = ['594694239598' , '594694239598'] //premium number
global.pengguna = 'Rashirikun Dev Edition' //username
global.port = process.env.PORT || 5000
global.botnma = process.env.botnma || 'Rashirikun Dev Edition ' //bot name
global.watermark = "ENJOY WITH Rashirikun"
global.dogeemoji = "✨"
global.botname = process.env.BOT_NAME || 'Rashirikun '
global.ownernma = 'Ikshwaku Pandey' //owner name
global.ownername = process.env.OWNER_NAME || 'Julin' //owner name
global.mongodb = process.env.MONGODB_URI || "No_URI"  // Mongo db secret URI
global.packname = process.env.SPACK_NAME || 'Rashirikun! youtube ' //sticker package name
global.author = 'Rashrikun! youtube' //sticker author name
global.sessionName = 'session.sam' //session name
global.zerotwo = "https://github.com/rashirikun/Zero-Two-MD" //ur gc link
global.zerotwo2 = "https://github.com/rashirikun/Zero-Two-MD" //ur gc link2
global.websitex = "https://github.com/rashirikun/Zero-Two-MD" //ur website
global.prefa = ['-'] //prefix
global.sp = '✨' //design
global.mess = {
    success: 'Done ✓',
    admin: '𝑻𝒉𝒊𝒔 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝒊𝒔 𝒐𝒏𝒍𝒚 𝒇𝒐𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒅𝒎𝒊𝒏  ',
    botAdmin: '𝑰𝒇 𝒚𝒐𝒖 𝒓𝒆𝒂𝒍𝒍𝒚 𝒘𝒂𝒏𝒕 𝒎𝒆 𝒕𝒐 𝒅𝒐 𝒕𝒉𝒂𝒕,𝑮𝒊𝒗𝒆 𝒎𝒆 𝒂𝒅𝒎𝒊𝒏 𝒑𝒓𝒊𝒗𝒊𝒍𝒆𝒈𝒆 baka❗',
    owner: '𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐢𝐬 𝐨𝐧𝐥𝐲 𝐟𝐨𝐫 𝐌𝐲 𝐋𝐨𝐫𝐝 𝐎𝐰𝐧𝐞𝐫 julin ' ,
    ...
    ban: 'You are banned by the owner, if you want to be unbanned, chat with julin.',
